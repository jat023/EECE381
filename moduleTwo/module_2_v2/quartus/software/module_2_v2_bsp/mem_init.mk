...
MEM_0 := nios_system_dual_port_ram
$(MEM_0)_NAME := dual_port_ram
...
$(MEM_0)_HIERARCHICAL_PATH := dual_port_ram
$(MEM_0)_WIDTH := 8
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: dual_port_ram
dual_port_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
